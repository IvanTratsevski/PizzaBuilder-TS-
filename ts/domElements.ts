import {
    ...
    sauceImg,
    basicPathesToImgs,
    classesOfDOMElements} from "./constants.js";
abstract class addableComponent{
    abstract type: typesOfComponents;
    abstract classOfDOMElement: classesOfDOMElements;
    abstract fullPathToImg: string;
    constructor(
        public price: number,
        public name: string,
...
const addableComponents: (baseComponent | ingridient1Component | ingridient2Component | sauceComponent)[] = [
